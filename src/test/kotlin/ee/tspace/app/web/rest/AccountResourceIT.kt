...
import ee.tspace.app.TspaceApp
import ee.tspace.app.config.DEFAULT_LANGUAGE
import ee.tspace.app.domain.User
import ee.tspace.app.repository.AuthorityRepository
import ee.tspace.app.repository.UserRepository
import ee.tspace.app.security.ADMIN
import ee.tspace.app.security.USER
...
@SpringBootTest(classes = [TspaceApp::class])
