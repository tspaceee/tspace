...
class CacheConfiguration(
    ...
    fun cacheManagerCustomizer(): JCacheManagerCustomizer {
        return JCacheManagerCustomizer { cm ->
            createCache(cm, ee.tspace.app.repository.UserRepository.USERS_BY_LOGIN_CACHE)
            createCache(cm, ee.tspace.app.repository.UserRepository.USERS_BY_EMAIL_CACHE)
            createCache(cm, ee.tspace.app.domain.User::class.java.name)
            createCache(cm, ee.tspace.app.domain.Authority::class.java.name)
            createCache(cm, ee.tspace.app.domain.User::class.java.name + ".authorities")
